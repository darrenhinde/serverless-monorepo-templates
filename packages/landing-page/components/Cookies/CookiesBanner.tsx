...
export const CookiesBanner = (props: CookiesBannerProps) => {
  return (
    <Paper withBorder p="lg" radius="md" shadow="md">
      ...
      <Text c="dimmed" fz="xs">
        We use cookies to improve your experience and optimize our service. This includes analytical
        cookies (e.g., via PostHog) and essential cookies for running the application. You can
        change your consent at any time. For more information, please see our{' '}
        <Link
